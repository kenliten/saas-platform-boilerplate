...
<body>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
        ...
        <symbol id="file-earmark" viewBox="0 0 16 16">
            <path
                d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2z"></path>
        </symbol>
        <symbol id="file-earmark-text" viewBox="0 0 16 16">
            <path
                d="M5.5 7a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5zM5 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5z"></path>
            <path
                d="M9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.5L9.5 0zm0 1v2A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5z"></path>
        </symbol>
    ...
    <header
        ...
        data-bs-theme="dark">
        <a
            class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white d-flex gap-2 align-items-center"
            href="/dashboard">
            <img src="<?= env('APP_LOGO') ?>" alt="<?= env('APP_NAME') ?> Logo" class="img-fluid me-1" style="width: 32px;">
        ...
        <div class="navbar-item ms-auto d-flex gap-2">
            <a href="/notifications" class="nav-link text-light px-3">
                <i style="vertical-align: 0;" class="bi bi-bell"></i>
                <?php if (isset($notifications_count) && $notifications_count > 0): ?>
                    <span class="badge bg-danger"><?= $notifications_count ?></span>
                <?php endif; ?>
            </a>
        </div>
        <div class="navbar-item mx-3 d-flex gap-2">
            <a href="/profile" class="nav-link text-light px-3">
                <i style="vertical-align: 0;" class="bi bi-person"></i>
            </a>
        </div>
        <form action="/logout" method="post" id="logout-form" class="navbar-item me-3 d-flex gap-2">
            <?= \App\Core\Csrf::field() ?>
            <a href="#" onclick="document.getElementById('logout-form').submit();" class="text-light navbar-link border-0 px-3">
                <i style="vertical-align: 0;" class="bi bi-box-arrow-right"></i>
            </a>
        </form>
    </header>
                    ...
                    <div
                        ...
                        <ul class="nav flex-column">
                            ...
                            <?php if (user_role() === 'admin'): ?>
                                <hr class="my-3" />
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center gap-2 <?= strpos($_SERVER['REQUEST_URI'], '/admin/users') !== false ? 'active' : '' ?>" href="/admin/users">
                                        <i class="bi bi-people"></i>
                                        <?= __('user_management') ?>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center gap-2 <?= strpos($_SERVER['REQUEST_URI'], '/admin/notifications') !== false ? 'active' : '' ?>" href="/admin/notifications">
                                        <i class="bi bi-megaphone"></i>
                                        <?= __('notification_sender') ?>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center gap-2 <?= strpos($_SERVER['REQUEST_URI'], '/health') !== false ? 'active' : '' ?>" href="/health">
